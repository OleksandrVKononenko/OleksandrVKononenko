...
public class EtlUtil { 
	...
	{ 
		...
		int count_of_fields = getCountOfFields(fileSource); 
				 
		gl.tracex(new Object(){},String.format("Fields count is ...%d",count_of_fields)); 
		 
		if(count_of_fields != 7) 
		{ 
			gl.tracex(new Object(){},String.format("Fields count is invalid...%d...%s",count_of_fields,gl.S_ERROR)); 
	...
	public static boolean fileTranslateEx(String fileSource) 
	{ 
		...
		list.forEach(a->{ 
			...
			String target = rowTranslateGold(a); 
	...
	public static int getCountOfFields(String source_file) 
	{ 
	...
	public static void main(String[] args) { 
		...
		//String input_file = "d:\\exp\\ava\\dax301440.csv"; 
		 
		//String input_file = "d:\\exp\\ava\\audcad.txt"; 
		 
		//Test_fileTranslate(input_file); 
		 
		 filesTranslate("d:\\exp\\ava\\"); 
