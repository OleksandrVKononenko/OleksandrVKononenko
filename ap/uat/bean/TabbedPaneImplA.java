...
public class TabbedPaneImplA extends JTabbedPane implements MouseListener,MouseMotionListener{ 

	private XTabbedPaneA proxy; 
	 
	public XTabbedPaneA getProxy() { 
		return proxy; 
	} 

	public void setOwner(XTabbedPaneA owner) { 
		this.proxy = owner; 
	} 

	 
	public TabbedPaneImplA() { 
...
this.setTabLayoutPolicy(JTabbedPane.SCROLL_TAB_LAYOUT); 
	...
	public TabbedPaneImplA(int tabPlacement) { 
		super(tabPlacement); 
		 
	} 

	public TabbedPaneImplA(int tabPlacement, int tabLayoutPolicy) { 
	...
	public static TabbedPaneImplA get_instance() { 

		return new TabbedPaneImplA(); 
