...
public class TableImpl extends JTable implements MouseListener,MouseMotionListener { 

	private XTable proxy; 
	 
	public XTable getProxy() { 
		return proxy; 
	} 

	public void setOwner(XTable owner) { 
		this.proxy = owner; 
	} 
	...
	public TableImpl(TableModel dm) { 
		super(dm); 
	...
	public TableImpl(TableModel dm, TableColumnModel cm) { 
		super(dm, cm); 
		 
	} 

	public TableImpl(int numRows, int numColumns) { 
		super(numRows, numColumns); 
		 
	} 

	public TableImpl(Vector rowData, Vector columnNames) { 
		super(rowData, columnNames); 
		 
	} 

	public TableImpl(Object[][] rowData, Object[] columnNames) { 
		super(rowData, columnNames); 
		 
	} 

	public TableImpl(TableModel dm, TableColumnModel cm, ListSelectionModel sm) { 
		super(dm, cm, sm); 
	...
	public static TableImpl get_instance() 
	{ 
			...
			TableImpl table = new TableImpl(dtm); 
